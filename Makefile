TOPDIR=$(shell pwd)
BUILD_SLN=./jaytwo.Rounding.sln
BUILD_DIR=./src/jaytwo.Rounding
BUILD_TEST_DIR=./test/jaytwo.Rounding.Tests
BUILD_TRX_FILENAME=jaytwo.Rounding.Tests.trx
BUILD_PACKED_DIR=${TOPDIR}/out/packed
DOCKER_TAG?=jaytwo_rounding
